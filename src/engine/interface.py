...
class Slider:
    def __init__(
        self, x, y, width, height, min_value, max_value, step, screen, start_value=None
    ):
        self.screen = screen
    ...
    def update(self, events):
        for event in events:
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                distance = math.sqrt(
                    (mouse_x - self.handle_pos) ** 2
                    + (mouse_y - self.rect.centery) ** 2
                )
                ...
                self.handle_pos = max(
                    self.rect.left, min(event.pos[0], self.rect.right)
                )
                self.value = self.min_value + (
                    self.handle_pos - self.rect.left
...
class ExperienceBar:
    ...
    def draw(self):
        ...
        pygame.draw.rect(
            self.screen, (0, 0, 0), (self.x, self.y, self.width, self.height)
        )
        fill_width = int((self.current_exp / self.max_exp) * self.width)
        pygame.draw.rect(
            self.screen, (0, 255, 0), (self.x, self.y, fill_width, self.height)
        )
...
class UpgradeManager:
    def __init__(self, screen):
        self.screen = screen
        self.hp_sprite = pygame.transform.scale(
            pygame.image.load("../assets/max_hp_icon.png"), (130, 90)
        )
        self.damage_sprite = pygame.transform.scale(
            pygame.image.load("../assets/attack_icon.png"), (130, 90)
        )
        self.attack_speed_sprite = pygame.transform.scale(
            pygame.image.load("../assets/attack_speed_icon.png"), (130, 90)
        )
        self.crit_sprite = pygame.transform.scale(
            pygame.image.load("../assets/crit_icon.png"), (130, 90)
        )
        self.crit_chance_sprite = pygame.transform.scale(
            pygame.image.load("../assets/crit_chance_icon.png"), (130, 90)
        )
        self.hp_button = Button(
            ...
            625,
            90,
            "Повышает максимальное здоровье на 100",
            "../assets/Default.png",
            self.screen,
        )
        self.damage_button = Button(
            ...
            625,
            90,
            "Повышает урон от атаки на 20%",
            "../assets/Default.png",
            self.screen,
        )
        self.attack_speed_button = Button(
            150,
            260,
            625,
            90,
            "Повышает скорость атаки на 0.5 единиц",
            "../assets/Default.png",
            self.screen,
        )
        self.crit_button = Button(
            150,
            350,
            625,
            90,
            "Повышает критический урон на 20%",
            "../assets/Default.png",
            self.screen,
        )
        self.crit_chance_button = Button(
            150,
            440,
            625,
            90,
        ...
        self.cancel_button = Button(
            150, 540, 625, 50, "Закрыть", "../assets/Default.png", self.screen
        )
...
class BossBar:
    ...
    def draw(self):
        ...
        pygame.draw.rect(
            self.screen, (255, 0, 0), (self.x, self.y, fill_width, self.height)
        )
        font = pygame.font.Font(None, 25)
